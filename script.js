...
function openCrestMaker() {
    ...
    overlay.innerHTML = `
        <div class="premier-logo-modal" role="dialog" aria-modal="true" aria-label="Premier logo changer">
            ...
            <div class="premier-logo-body">
                ...
                <div class="premier-logo-editor" data-panel="edit" hidden><div class="premier-editor-toolbar"><button type="button" class="premier-back">Back to logos</button><span>Customize colors</span></div><div class="premier-editor-preview"><canvas width="300" height="300"></canvas></div><div class="premier-editor-controls"><div class="premier-color-heading">Choose a layer to recolor</div><div class="premier-color-roles"><button type="button" class="premier-color-role active" data-role="primary"><span class="premier-role-dot"></span><span>Primary</span><strong class="premier-role-value">#FF0000</strong></button><button type="button" class="premier-color-role" data-role="secondary"><span class="premier-role-dot"></span><span>Secondary</span><strong class="premier-role-value">#00FF00</strong></button><button type="button" class="premier-color-role" data-role="border"><span class="premier-role-dot"></span><span>Border</span><strong class="premier-role-value">#0000FF</strong></button></div><div class="premier-color-heading">Premier palette</div><div class="premier-color-swatches"></div><label>Selected layer color<input class="premier-active-color-input" type="color" value="#ff0000"></label><label>Background<input class="premier-bg-input" type="color" value="#343236"></label><label class="premier-check"><input class="premier-bg-toggle" type="checkbox"> Show background</label><button type="button" class="download-btn premier-use-created">Use this logo</button></div></div>
            </div>
        </div>`;
    ...
    const roleInputs = {
        primary: { input: document.createElement("input"), color: "#ff0000" },
        secondary: { input: document.createElement("input"), color: "#00ff00" },
        border: { input: document.createElement("input"), color: "#0000ff" }
    };
    ...
    function drawEditor() {
        ...
        image.onload = () => {
            ...
            for (let i = 0; i < pixels.data.length; i += 4) {
                ...
                const color = red >= green * 1.15 && red >= blue * 1.15
                    ? primary
                    : green >= red * 1.15 && green >= blue * 1.15
                        ? secondary
                        : blue >= red * 1.15 && blue >= green * 1.15 ? border : null;
                if (!color) continue;
