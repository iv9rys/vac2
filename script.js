...
function openCrestMaker() {
    ...
    const colorInput = overlay.querySelector(".premier-color-input");
    const swatchRow = overlay.querySelector(".premier-color-swatches");
    const logoColors = ["#2f5cff", "#ff4655", "#22c55e", "#f59e0b", "#a855f7", "#06b6d4", "#f4f4f5", "#16161a"];
    ...
    logoColors.forEach(color => {
        ...
        swatch.title = color;
        swatch.addEventListener("click", () => { colorInput.value = color; swatchRow.querySelectorAll(".premier-color-swatch").forEach(item => item.classList.remove("active")); swatch.classList.add("active"); drawEditor(); });
    ...
    colorInput.addEventListener("input", () => { swatchRow.querySelectorAll(".premier-color-swatch").forEach(item => item.classList.remove("active")); drawEditor(); });
