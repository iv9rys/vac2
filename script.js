...
function normalizeTeamLogo(source) {
    ...
    const markers = ["/Premier logos/", "/premier-logos/"];
...
function openCrestMaker() {
    ...
    PREMIER_LOGOS.forEach(name => {
        ...
        button.addEventListener("click", () => { selectedName = name; selectedSource = `Premier logos/Premier_Team_Logo_${name}.webp`; grid.querySelectorAll(".premier-logo-choice").forEach(item => item.classList.remove("active")); button.classList.add("active"); markSelect.value = name; drawEditor(); });
