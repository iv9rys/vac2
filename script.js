...
function openCrestMaker() {
    ...
    overlay.innerHTML = `
        <div class="premier-logo-modal" role="dialog" aria-modal="true" aria-label="Premier logo changer">
            ...
            <div class="premier-logo-body">
                ...
                <div class="premier-logo-editor" data-panel="edit" hidden><div class="premier-editor-toolbar"><button type="button" class="premier-back">Back to logos</button><span>Customize colors</span></div><div class="premier-editor-preview"><canvas width="300" height="300"></canvas></div><div class="premier-editor-controls"><div class="premier-color-heading">Logo colors</div><div class="premier-color-swatches"></div><label>Primary<input class="premier-primary-input" type="color" value="#dd3b41"></label><label>Secondary<input class="premier-secondary-input" type="color" value="#edc657"></label><label>Border<input class="premier-border-input" type="color" value="#343236"></label><label>Background<input class="premier-bg-input" type="color" value="#343236"></label><label class="premier-check"><input class="premier-bg-toggle" type="checkbox"> Show background</label><button type="button" class="download-btn premier-use-created">Use this logo</button></div></div>
            </div>
        </div>`;
    ...
    const primaryInput = overlay.querySelector(".premier-primary-input");
    const secondaryInput = overlay.querySelector(".premier-secondary-input");
    const borderInput = overlay.querySelector(".premier-border-input");
    ...
    logoColors.forEach(color => {
        ...
        swatch.title = color;
        swatch.addEventListener("click", () => { primaryInput.value = color; swatchRow.querySelectorAll(".premier-color-swatch").forEach(item => item.classList.remove("active")); swatch.classList.add("active"); drawEditor(); });
        swatchRow.appendChild(swatch);
    });
    swatchRow.firstElementChild.classList.add("active");
    ...
    [".premier-primary-input", ".premier-secondary-input", ".premier-border-input", ".premier-bg-input", ".premier-bg-toggle"].forEach(selector => overlay.querySelector(selector).addEventListener("input", drawEditor));
